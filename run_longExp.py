...
parser.add_argument('--model', type=str, required=True, default='PatchMixer',
                    help='model name, options: [Autoformer, Informer, Transformer]')

# data loader
parser.add_argument('--data', type=str, required=True, default='A123Custom', help='dataset type')
parser.add_argument('--root_path', type=str, default='./dataset/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='A1-007-DST-merged.csv', help='data file')
parser.add_argument('--test_data_path', type=str, default='A1-007-US06-50-20120824.csv', help=' test data file')
...
parser.add_argument('--pred_len', type=int, default=26, help='prediction sequence length')
